...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tImage = '<img src="{data}" width="98%" class="file-preview-image kv-preview-data" title="{caption}" ' +
                'alt="{caption}"' + tStyle + '>\n';
            ...
            self.defaults = {
                ...
                previewTemplates: {},
                previewSettings: {
                    image: {width: "98%", height: "auto", 'max-width': "100%", 'max-height': "100%"},
                ...
                fileActionSettings: {
                    ...
                    dragIcon: '<i class="glyphicon glyphicon-trash"></i>',
                    dragClass: 'text-info',
    ...
    $.fn.fileinput.defaults = {
        ...
        removeIcon: '<i class="glyphicon glyphicon-search-plus"></i>',
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgImageWidthSmall: ' "{name}" 图片宽度 至少 {size} px.',
        msgImageHeightSmall: 'Height of image file "{name}" must be at least {size} px.',
        msgImageWidthLarge: ' "{name}"图片宽度 不能超过 {size} px.',
