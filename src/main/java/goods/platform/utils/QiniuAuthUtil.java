...
public final class QiniuAuthUtil {
	...
	private  void copyPolicy(final StringMap policy, StringMap originPolicy, final boolean strict) {
	...
	static class LinkingDtokenStatement {
